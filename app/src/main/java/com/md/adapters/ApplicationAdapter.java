...
import com.md.R;
import com.md.activities.RecyclerListActivity;
...
public class ApplicationAdapter extends RecyclerView.Adapter<ApplicationAdapter.ViewHolder> {
    ...
    private RecyclerListActivity mAct;

    public ApplicationAdapter(List<AppInfo> applications, int rowLayout, RecyclerListActivity act) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAct.animateActivity(appInfo, viewHolder.image,viewHolder.name);
            }
        });
    }
