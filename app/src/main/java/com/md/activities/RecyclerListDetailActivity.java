...
public class RecyclerListDetailActivity extends BaseActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_list_detail);
    }
    ...
    public void initView() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RecyclerListDetailActivity.this.onBackPressed();
            }
        });
        ...
        fab.setImageDrawable(new IconicsDrawable(this, GoogleMaterial.Icon.gmd_file_upload).color(Color.WHITE).actionBar());
